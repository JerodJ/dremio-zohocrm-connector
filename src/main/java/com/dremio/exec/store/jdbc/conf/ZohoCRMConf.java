...
@SourceType(value = "ZohoCRMARP", label = "ZohoCRM",uiConfig = "zohocrm-layout.json")
public class ZohoCRMConf extends AbstractArpConf<ZohoCRMConf> {
  private static final String ARP_FILENAME = "arp/implementation/zohocrm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.zohocrm.ZohoCRMDriver";
