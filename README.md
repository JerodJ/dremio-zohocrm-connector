...
3. Download and install the [Zoho CRM JDBC Driver from CData](https://www.cdata.com/drivers/zohocrm/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
